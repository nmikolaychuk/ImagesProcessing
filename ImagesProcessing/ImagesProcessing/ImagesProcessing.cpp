...
// ImagesProcessing.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CImagesProcessingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CImagesProcessingApp

CImagesProcessingApp::CImagesProcessingApp()
{
...
// Единственный объект CImagesProcessingApp

CImagesProcessingApp theApp;


// Инициализация CImagesProcessingApp

BOOL CImagesProcessingApp::InitInstance()
{
